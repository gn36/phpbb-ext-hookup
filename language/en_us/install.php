...
$lang = array_merge($lang, array(
	...
	'MISSING_DEPENDENCIES' 		=> 'To install this extension, the package <strong>%s</strong> must be included in this extension, but it is missing. Please use composer to install the missing dependencies or use a complete installation package.',
