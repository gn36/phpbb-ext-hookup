...
$lang = array_merge($lang, array(
	...
	'ADD_HOOKUP_REACTIVATE_EXPLAIN' => 'Es existieren noch Daten eines zuvor deaktivierten Terminplaners. Wenn Sie diesen reaktivieren, sind die alten Benutzer und Termine wieder verfügbar.',
	...
	'HOOKUP_ADD_DATES_EXPLAIN'=> 'Hiermit fügen Sie neue Datumsvorschläge oder Auswahloptionen in die Liste ein. Geben Sie pro Zeile ein Datum im Format TT.MM.JJJJ ss:mm, JJJJ-MM-TT ss:mm ein oder fügen Sie eine Option im Textformat ein, indem Sie am Anfang der Zeile ein # einfügen.',
	...
	'USERNAMES_EXPLAIN'		=> 'Hiermit können Sie neue Benutzer in die Liste einfügen. Sie können mehrere User gleichzeitig eingeben. Verwenden Sie für jeden User eine neue Zeile.',
	'HOOKUP_ADD_GROUPS_EXPLAIN'=> 'Hiermit können Sie komplette Gruppen in die Liste einfügen. Die Mitglieder der Gruppe werden einzeln in die Liste eingefügt, eine Mehrfachauswahl ist möglich.',
	'HOOKUP_OVERVIEW'		=> 'Terminplaner-Übersicht',
	'DATE_ALREADY_ADDED'	=> 'Das Datum %1s wurde diesem Terminplaner bereits hinzugefügt',
	'HOOKUP_DELETE_EXPLAIN'	=> 'Hier können Sie einzelne Benutzer/Datumsvorschläge oder den kompletten Terminplaner löschen',
	...
	'DELETE_HOOKUP_DISABLE_CONFIRM'	=> 'Wollen Sie den Terminplaner wirklich deaktivieren? Die Gespeicherten Daten (Benutzer, Datumsvorschläge, Verfügbarkeitsinformationen) bleiben in der Datenbank gespeichert und der Terminplaner kann jederzeit wieder reaktiviert werden.',
	...
	'DELETE_HOOKUP_DELETE_CONFIRM'	=> 'Wollen Sie den Terminplaner wirklich vollständig löschen? Die Gespeicherten Daten (Benutzer, Datumsvorschläge, Verfügbarkeitsinformationen) gehen verloren und können nicht wiederhergestellt werden.',
	'DELETE_USERS'			=> 'Einzelne Benutzer löschen',
	'DELETE_DATES'			=> 'Einzelne Datumsvorschläge löschen',
	'HOOKUP_DELETE_VIEWTOPIC_EXPLAIN' => 'Dieses Thema enthält bereits einen aktiven Terminplaner. Um den gesamten Terminplaner oder einzelne Benutzer/Datumsvorschläge zu löschen, verwenden Sie bitte den Reiter <em>Löschen</em> in der Themenansicht',
	'HOOKUP_DELETE_CONFIRM'	=> array(
		'USERS' => 'Möchten Sie wirklich %s löschen?',
		'DATES'	=> 'Möchten Sie wirklich %s löschen?',
		'UANDD' => 'Möchten Sie wirklich %s und %s löschen?',
	),
	'DATES' => array(
		1 => '1 Datumsvorschlag',
	...
	'HOOKUP_INVITE_SELF_EXPLAIN' => 'Dies ist ein offener Terminplaner, jeder Interessent kann sich selbst als Teilnehmer eintragen. Wenn Sie an diesem Termin teilnehmen möchten, verwenden Sie dazu bitte den folgenden Button.',
	'HOOKUP_INVITE_SELF_EXPLAIN_GUEST' => 'Dies ist ein offener Terminplaner, jeder Interessent kann sich selbst als Teilnehmer eintragen. Um diese Funktion nutzen zu können, müssen Sie sich jedoch zuerst im Forum anmelden.',
	'HOOKUP_INVITE_SELF_LEAVE'	=> 'Teilnahme beenden',
	'HOOKUP_INVITE_SELF_LEAVE_DESC'	=> 'Klicken Sie hier, um Ihre Teilnahme an diesem Terminplaner zu beenden.',
	'HOOKUP_INVITE_SELF_LEAVE_EXPLAIN' => 'Sie sind derzeit ein Mitglied dieses Terminplaners. Verwenden Sie den folgenden Button, wenn Sie nicht mehr teilnehmen möchten.',
	'HOOKUP_INVITE_SELF_LEAVE_CONFIRM' => 'Möchten Sie Uhre Teilnahme an diesem Terminplaner wirklich beenden?',
	'HOOKUP_INVITE_MYSELF'	=> 'Mich selbst einladen',
	'COMMENT'				=> 'Kommentar',
	'COMMENT_EXPLAIN'		=> 'Sie können optional einen Kommentar angeben, der Ihre Angaben oben in der Liste erläutert. Das ist besonders beim Eintrag „evtl.“ nützlich. Der Kommentar erscheint dann als Popup unter einem Kommentarsymbol hinter Ihrem Benutzernamen.',
	'HOOKUP_AUTORESET'		=> 'Wöchentliches Rücksetzen',
	'HOOKUP_AUTORESET_DESC'	=> 'Mit dieser Einstellung können Sie den Terminplaner so einstellen, dass er sich automatisch wöchentlich aktualisiert.<br /> Durch diese Einstellung wird der erste eingetragene Termin wöchentlich wiederholt.',
